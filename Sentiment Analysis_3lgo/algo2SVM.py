...
def sentiment_analysis():
    ...
    # TRAINING THE DATA
    classifier = SVC(kernel='linear', C=1.0)  # Use a linear Support Vector Machine
    ...
    plt.savefig('static/sentiment_bar2.png')  # Save the bar chart as an image
    plt.close()

    return render_template('algo2.html', accuracy=accuracy, classification_report=classification_report(y_test, y_pred))
